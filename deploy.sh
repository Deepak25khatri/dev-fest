...
SERVICE_NAME=${SERVICE_NAME:-"adk-schedule-agent"}
APP_NAME=${APP_NAME:-"schedule-agent"}
AGENT_PATH=${AGENT_PATH:-"/Users/bhargav/Desktop/My-Computer/Blogs/Blog-Resources/schedule-agent"}
